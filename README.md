...
Convención de nombres recomendada: todo en minúsculas, palabras separadas por guiones, sin espacios ni caracteres especiales.

```
public/documentos/convenio-cct-2024-2025.pdf
public/documentos/acta-asamblea-2024.pdf
public/documentos/formulario-afiliacion.pdf
```

### 2. Editar la lista en Documents.jsx

Abrir `src/components/Documents.jsx` y localizar el array `DOCS` al inicio del archivo. Cada entrada tiene esta forma:

```js
{
  id: 7,                              // número único, correlativo
  category: 'Convenio',              // etiqueta visible (Estatutos, Convenio, Informe, Guía, Asamblea, Formulario…)
  ...
  href: '/documentos/convenio-cct-2024-2025.pdf',  // ruta pública del archivo
...
└── components/
    ...
    ├── News.jsx/css
    ├── Documents.jsx/css
    ├── DocumentViewer.jsx/css   ← modal de vista previa PDF
    ├── Contact.jsx/css
    └── Footer.jsx/css
```
